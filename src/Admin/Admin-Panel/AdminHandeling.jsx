...
const AdminHandling = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins`)
  ...
  const handleAddAdmin = (e) => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins`, newAdmin)
      .then((response) => {
  ...
  const handleEditAdmin = (e) => {
    ...
    axios
      .put(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins/${editAdmin.id}`, editAdmin)
      .then((response) => {
        setAdmins(
  ...
  const confirmDelete = () => {
    ...
    axios
      .post(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins/validatePassword/${deleteAdminId}`, { password: deletePassword })
      .then((response) => {
        if (response.data.isValid) {
          axios
            .delete(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins/${deleteAdminId}`)
            .then(() => {
  ...
  const handlePasswordChange = (e) => {
    ...
    axios
      .put(`${import.meta.env.VITE_BACKEND_API_URI}/api/admins/updatePassword/${editAdmin.id}`, {
        oldPassword,
        newPassword
      })
      .then((response) => {
